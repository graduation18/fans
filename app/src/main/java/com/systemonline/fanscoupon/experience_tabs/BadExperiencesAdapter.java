...
public class BadExperiencesAdapter extends BaseAdapter {
    ...
    BadExperiencesAdapter(Context c, ArrayList<Experience> values) {
        super(c, R.layout.experience_tab_bad, values);
        this.con = c;
        this.values = values;
...
//        rootView = finalRow;
        ...
        edit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ExperienceTab.experienceToEdit = ExperienceTab.allExperiences.get(1).get(position);
...
//                Log.e("good adapter show",rootView.toString());
                JSONWebServices service = new JSONWebServices(BadExperiencesAdapter.this);
...
//                utility.HideDialog(rootView);
                ...
                Log.e("update all", utility.updateExperiences(1, expSlug) + " -- ");
