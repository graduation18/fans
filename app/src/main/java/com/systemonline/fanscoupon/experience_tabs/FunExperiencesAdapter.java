...
public class FunExperiencesAdapter extends BaseAdapter {
    ...
    FunExperiencesAdapter(Context c, ArrayList<Experience> values) {
        super(c, R.layout.experience_tab_fun_experiences, values);
        this.con = c;
        this.values = values;
...
//        rootView = finalRow;
        ...
        edit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ExperienceTab.experienceToEdit = ExperienceTab.allExperiences.get(2).get(position);
...
//                utility.ShowDialog(rootView);
//                Log.e("good adapter show",rootView.toString());
                JSONWebServices service = new JSONWebServices(FunExperiencesAdapter.this);
...
//                utility.HideDialog(rootView);
                ...
                Log.e("update all", utility.updateExperiences(2, expSlug) + " -- ");
