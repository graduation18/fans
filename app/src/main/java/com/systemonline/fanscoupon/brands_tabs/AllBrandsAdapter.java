...
public class AllBrandsAdapter extends BaseAdapter {
    ...
    AllBrandsAdapter(Context c, ArrayList<Brand> values) {
        super(c, R.layout.brand_tab_all_brands, values);
        this.con = c;
        this.values = values;
    ...
    public View getView(int position, View row, @NonNull ViewGroup parent) {
        ...
        if (row == null) {
            ...
            row = inflater.inflate(R.layout.brand_tab_all_brands_row, parent, false);
        }
