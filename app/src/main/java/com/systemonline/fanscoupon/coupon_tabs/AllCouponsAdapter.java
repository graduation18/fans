...
//            utility.showMessage(getContext().getResources().getString(R.string.must_login_fb), true);
//        }
//    };
//
//    AllCouponsAdapter(Context c, ArrayList<Coupon> values) {
...
//            row = inflater.inflate(R.layout.cop_tab_all_coupons_row, parent, false);
//        }
...
//        TextView cop_timer = (TextView) row.findViewById(R.id.cop_timer);
//        cop_type.setText(coupon.getCouponType());
//        cop_timer.setVisibility(View.GONE);
...
//        ImageView lin_share_fb = (ImageView) row.findViewById(R.id.lin_share_fb);
...
//        final LikeView likeView = (LikeView) row.findViewById(R.id.allCoup_like_view);
...
//                cop_timer.setBackgroundColor(getContext().getResources().getColor(R.color.black));
//                break;
//            case 240:
...
//        strBuild = utility.getCurrentActivity().getResources().getString(R.string.win);
//        strColor = new SpannableString(strBuild);
//        strColor.setSpan(new ForegroundColorSpan(utility.getCurrentActivity().getResources().getColor(R.color.red)), 0, strBuild.length(), 0);
//        builder.append(strColor);
//        builder.append(" ");
//        builder.append(coupon.getCouponName());
//        win_all.setText(builder, TextView.BufferType.SPANNABLE);
//        utility.setTextViewLines(win_all, builder.toString());
//
...
//        }
//
//        if (CouponTab.selectedCoupType.equals("challenges")) {
//            if (!coupon.getCouponChallenges().isMissionStatus())
//                addToWallet.setText(getContext().getResources().getString(R.string.start_challenge));
//            builder = new SpannableStringBuilder();
//            strBuild = utility.getCurrentActivity().getResources().getString(R.string.challenge);
//            strColor = new SpannableString(strBuild);
//            strColor.setSpan(new ForegroundColorSpan(utility.getCurrentActivity().getResources().getColor(R.color.red)), 0, strBuild.length(), 0);
//            builder.append(strColor);
//            builder.append(" ");
//            builder.append(coupon.getCouponChallenges().getChallengeName());
//            ch_all.setText(builder, TextView.BufferType.SPANNABLE);
//            utility.setTextViewLines(ch_all, builder.toString());
//        } else
...
//                        .setContentDescription(getContext().getResources().getString(R.string.fan_cop_test))
...
//
//        JSONWebServices service = new JSONWebServices(AllCouponsAdapter.this);
