...
public class AllCouponsAdapter2 extends BaseAdapter {
    ...
    AllCouponsAdapter2(Context c, ArrayList<Coupon> values, int selectedCopTypeID, String selectedCoupType) {
    ...
    public View getView(int position, View row, @NonNull ViewGroup parent) {
        ...
        //replacing image view with a facebook share button
        ShareButton lin_share_fb = (ShareButton) row.findViewById(R.id.lin_share_fb);
       //***********************************
...
//************************************************
        final LikeView likeView = (LikeView) row.findViewById(R.id.likeView);
        likeView.setObjectIdAndType(brandSocialPage, LikeView.ObjectType.PAGE);
        ...
        Log.w("brandSocialPage",brandSocialPage);
//***************************************
        ...
        if (selectedCoupType.equals("challenges")) {
            ...
            utility.setTextViewLines(ch_all, utility.colorString(R.string.challenge, R.color.red, coupon.getCouponChallenges().getChallengeName(), R.color.black).toString());
        } else
        ...
        if (MainActivity.currentFan != null) {
            lin_share_fb.setShareContent(linkContent);
        ...
        lin_share_fb.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (MainActivity.currentFan != null) {
                    utility.showMessage(con.getResources().getString(R.string.plz_relogin));
...
//                                    utility.showMessage("Wrong coupon");
    ...
    private void eventRequestAdapter(String event) {
        ...
        JSONWebServices service = new JSONWebServices(AllCouponsAdapter2.this);
