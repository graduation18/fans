...
//
//class ForYouAdapter extends BaseAdapter {
...
//    };
//
//    ForYouAdapter(Context c, ArrayList<Coupon> values) {
...
//        utility.setTextViewLines(win_all, coupon.getCouponName());
//
//        if (CouponTab.selectedCoupTypeOnlyYou.equals("challenges")) {
...
//
//        JSONWebServices service = new JSONWebServices(ForYouAdapter.this);
